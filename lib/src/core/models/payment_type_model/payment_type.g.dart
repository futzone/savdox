...
extension PaymentTypeQueryFilter
  ...
  QueryBuilder<PaymentType, PaymentType, QAfterFilterCondition> sumEqualTo(
    double value, {
  ...
  QueryBuilder<PaymentType, PaymentType, QAfterFilterCondition> sumGreaterThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<PaymentType, PaymentType, QAfterFilterCondition> sumLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<PaymentType, PaymentType, QAfterFilterCondition> sumBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
